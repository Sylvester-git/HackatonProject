...
import 'package:sqaure_project/controller/authController.dart';
...
class LoginPage extends StatelessWidget {
  LoginPage({super.key, required this.nextscreencallback});
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => LognCubit(context.read<AuthRepo>()),
      child: Column(
        children: [
          SelectableText(
            'Welcome Back \n Ranker',
          ...
          BlocConsumer<LognCubit, LoginState>(
            listener: (context, loginListenerstate) {
              if (loginListenerstate.status == LoginStatus.success) {
                context.go('/home');
              }
            },
              ...
              return //Login Button
                ...
                child: Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    child: loginBuilderstate.status == LoginStatus.submitting
